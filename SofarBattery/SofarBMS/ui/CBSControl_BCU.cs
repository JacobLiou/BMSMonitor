...
namespace SofarBMS.UI
{
    public partial class CBSControl_BCU : UserControl
    {
        ...
        public List<FaultInfo> WarningNotify = new List<FaultInfo>()
        {
                    ...
                    new FaultInfo("SCI通讯故障,SCI_COMM_ERR",2,4,0,0,3),
        ...
        public List<FaultInfo> FaultNotify_DCDC = new List<FaultInfo>() {
                    ...
                    new FaultInfo("母线电压瞬时过压保护(PCU),BYTE2>>bit0",2,0,0,0,1),
                    new FaultInfo("母线电压瞬时欠压保护(PCU),BYTE2>>bit1",2,1,0,0,1),
                    new FaultInfo("母线短路保护(PCU),BYTE2>>bit2",2,2,0,0,1),
                    new FaultInfo("BCU-COM过压过流故障(PCU),BYTE2>>bit3",2,3,0,0,1),
