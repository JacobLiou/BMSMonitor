...
namespace SofarBMS.Model
{
    public class RealtimeData
    {
        ...
        {
            return "记录时间,电池ID,故障信息,告警信息,保护信息,电池状态,充电MOS,放电MOS,预充MOS,充电急停,加热MOS,电池电压,负载电压,电池电流,电池剩余容量(SOC),电池健康程度(SOH),剩余容量,满充容量,充电电流上限,放电电流上限,累计放电量,累计充电容量,累计放电容量,最高单体电压编号,最高单体电压,最低单体电压编号,最低单体电压,单体电压差,电压1,电压2,电压3,电压4,电压5,电压6,电压7,电压8,电压9,电压10,电压11,电压12,电压13,电压14,电压15,电压16,环境温度,Mos温度,最高单体温度编号,最高单体温度,最低单体温度编号,最低单体温度,温度1,温度2,温度3,温度4,温度5,温度6,温度7,温度8,工作状态,电池状态 ,机箱温度,散热器温度,高压侧电压,低压侧电压,低压侧电流,低压侧功率,高压充电电流,高压放电电流,PCU事件";
        }

        public string GetValue()
        {
            return $"{this.CreateDate},{this.PackID},{this.Fault},{this.Warning},{this.Protection},{this.BatteryStatus},{this.ChargeMosEnable} , {this.DischargeMosEnable}, {this.PrechgMosEnable}, {this.StopChgEnable}, {this.HeatEnable},{this.BatteryVolt},{this.LoadVolt},{this.BatteryCurrent},{this.SOC}, {this.SOH},{this.RemainingCapacity},{this.FullCapacity},{this.ChargeCurrentLimitation},{this.DischargeCurrentLimitation},{this.CumulativeDischargeCapacity},{this.TotalChgCap},{this.TotalDsgCap},{this.BatMaxCellVoltNum},{this.BatMaxCellVolt},{this.BatMinCellVoltNum},{this.BatMinCellVolt},{this.BatDiffCellVolt},{this.CellVoltage1},{this.CellVoltage2},{this.CellVoltage3},{this.CellVoltage4},{this.CellVoltage5},{this.CellVoltage6},{this.CellVoltage7},{this.CellVoltage8},{this.CellVoltage5},{this.CellVoltage6},{this.CellVoltage7},{this.CellVoltage8},{this.CellVoltage9},{this.CellVoltage10},{this.CellVoltage11},{this.CellVoltage12},{this.CellVoltage13},{this.CellVoltage14},{this.CellVoltage15},{this.CellVoltage16},{this.EnvTemperature},{this.MosTemperature},{this.BatMaxCellTempNum},{this.BatMaxCellTemp},{this.BatMinCellTempNum},{this.BatMinCellTemp},{this.CellTemperature1}, {this.CellTemperature2}, {this.CellTemperature3}, {this.CellTemperature4},{this.WorkState},{this.BatteryState},{this.CaseTemperature},{this.RadiatorTemperature},{this.HighvoltageSideVoltage},{this.LowvoltageSideVoltage},{this.LowvoltageSideCurrent},{this.LowvoltageSidePower},{this.HighvoltageChargingCurrent},{this.HighvoltageDischargeCurrent},{this.PcuEvents}";
        }
    }
}