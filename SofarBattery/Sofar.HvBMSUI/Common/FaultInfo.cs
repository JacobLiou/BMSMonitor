    ...
    public class FaultInfo
    {
        ...
        public static List<FaultInfo> FaultInfos4 = new List<FaultInfo>()
        {
            ...
            //type--类型2：设备硬件故障(data[0]=4)
                    ...
                    new FaultInfo("供电电压欠压报警     ",1,0,0,0,2),
                    new FaultInfo("供电电压过压报警     ",1,1,0,0,2),
                    new FaultInfo("模块温度过温报警     ",1,2,0,0,2),
                    new FaultInfo("组端电压欠压报警     ",1,3,0,0,2),
                    new FaultInfo("组端电压过压报警     ",1,4,0,0,2),
                    new FaultInfo("快充电流过流报警     ",1,5,0,0,2),
                    new FaultInfo("动力插件过温报警     ",1,6,0,0,2),
                    new FaultInfo("馈电电流过流报警     ",1,7,0,0,2),
                    new FaultInfo("放电电流过流报警     ",2,0,0,0,2),
                    new FaultInfo("绝缘电阻过低报警     ",2,1,0,0,2),
                    new FaultInfo("SOC过低报警          ",2,2,0,0,2),
                    new FaultInfo("SOC过高报警          ",2,3,0,0,2),
                    new FaultInfo("单体电压过压报警     ",2,4,0,0,2),
                    new FaultInfo("单体电压欠压报警     ",2,5,0,0,2),
                    new FaultInfo("单体压差报警         ",2,6,0,0,2),
                    new FaultInfo("充电单体过温报警     ",2,7,0,0,2),
                    new FaultInfo("充电单体欠温报警     ",3,0,0,0,2),
                    new FaultInfo("放电单体过温报警     ",3,1,0,0,2),
                    new FaultInfo("放电单体欠温报警     ",3,2,0,0,2),
                    new FaultInfo("单体温差报警         ",3,3,0,0,2),
                    new FaultInfo("SOC差异过大报警      ",3,4,0,0,2),
                    new FaultInfo("温升快报警           ",3,5,0,0,2),
                    new FaultInfo("模组过压报警         ",3,6,0,0,2),
                    new FaultInfo("模组欠压报警         ",3,7,0,0,2),

                    new FaultInfo("供电电压欠压报警     ",1,0,0,0,3),
                    new FaultInfo("供电电压过压报警     ",1,1,0,0,3),
                    new FaultInfo("模块温度过温报警     ",1,2,0,0,3),
                    new FaultInfo("组端电压欠压报警     ",1,3,0,0,3),
                    new FaultInfo("组端电压过压报警     ",1,4,0,0,3),
                    new FaultInfo("快充电流过流报警     ",1,5,0,0,3),
                    new FaultInfo("动力插件过温报警     ",1,6,0,0,3),
                    new FaultInfo("馈电电流过流报警     ",1,7,0,0,3),
                    new FaultInfo("放电电流过流报警     ",2,0,0,0,3),
                    new FaultInfo("绝缘电阻过低报警     ",2,1,0,0,3),
                    new FaultInfo("SOC过低报警          ",2,2,0,0,3),
                    new FaultInfo("SOC过高报警          ",2,3,0,0,3),
                    new FaultInfo("单体电压过压报警     ",2,4,0,0,3),
                    new FaultInfo("单体电压欠压报警     ",2,5,0,0,3),
                    new FaultInfo("单体压差报警         ",2,6,0,0,3),
                    new FaultInfo("充电单体过温报警     ",2,7,0,0,3),
                    new FaultInfo("充电单体欠温报警     ",3,0,0,0,3),
                    new FaultInfo("放电单体过温报警     ",3,1,0,0,3),
                    new FaultInfo("放电单体欠温报警     ",3,2,0,0,3),
                    new FaultInfo("单体温差报警         ",3,3,0,0,3),
                    new FaultInfo("SOC差异过大报警      ",3,4,0,0,3),
                    new FaultInfo("温升快报警           ",3,5,0,0,3),
                    new FaultInfo("模组过压报警         ",3,6,0,0,3),
                    new FaultInfo("模组欠压报警         ",3,7,0,0,3),

                    //new FaultInfo("供电电压欠压报警     ",1,0,0,0,4),
                    //new FaultInfo("供电电压过压报警     ",1,1,0,0,4),
                    //new FaultInfo("模块温度过温报警     ",1,2,0,0,4),
                    //new FaultInfo("组端电压欠压报警     ",1,3,0,0,4),
                    //new FaultInfo("组端电压过压报警     ",1,4,0,0,4),
                    //new FaultInfo("快充电流过流报警     ",1,5,0,0,4),
                    //new FaultInfo("动力插件过温报警     ",1,6,0,0,4),
                    //new FaultInfo("馈电电流过流报警     ",1,7,0,0,4),
                    //new FaultInfo("放电电流过流报警     ",2,0,0,0,4),
                    //new FaultInfo("绝缘电阻过低报警     ",2,1,0,0,4),
                    //new FaultInfo("SOC过低报警          ",2,2,0,0,4),
                    //new FaultInfo("SOC过高报警          ",2,3,0,0,4),
                    //new FaultInfo("单体电压过压报警     ",2,4,0,0,4),
                    //new FaultInfo("单体电压欠压报警     ",2,5,0,0,4),
                    //new FaultInfo("单体压差报警         ",2,6,0,0,4),
                    //new FaultInfo("充电单体过温报警     ",2,7,0,0,4),
                    //new FaultInfo("充电单体欠温报警     ",3,0,0,0,4),
                    //new FaultInfo("放电单体过温报警     ",3,1,0,0,4),
                    //new FaultInfo("放电单体欠温报警     ",3,2,0,0,4),
                    //new FaultInfo("单体温差报警         ",3,3,0,0,4),
                    //new FaultInfo("SOC差异过大报警      ",3,4,0,0,4),
                    //new FaultInfo("温升快报警           ",3,5,0,0,4),
                    //new FaultInfo("模组过压报警         ",3,6,0,0,4),
                    //new FaultInfo("模组欠压报警         ",3,7,0,0,4),

                    new FaultInfo("DI1检测故障          ",1,0,0,0,4),
                    new FaultInfo("DI2检测故障          ",1,1,0,0,4),
                    new FaultInfo("DI3检测故障          ",1,2,0,0,4),
                    new FaultInfo("DI4检测故障          ",1,3,0,0,4),
                    new FaultInfo("DI5检测故障          ",1,4,0,0,4),
                    new FaultInfo("DI6检测故障          ",1,5,0,0,4),
                    new FaultInfo("DI7检测故障          ",1,6,0,0,4),
                    new FaultInfo("DI8检测故障          ",1,7,0,0,4),
                    new FaultInfo("内网通讯故障         ",2,0,0,0,4),
                    new FaultInfo("单体电压采集故障     ",2,1,0,0,4),
                    new FaultInfo("单体温度采集故障     ",2,2,0,0,4),
                    new FaultInfo("显控下发故障         ",2,3,0,0,4),
                    new FaultInfo("簇间压差故障         ",2,4,0,0,4),
                    new FaultInfo("跳机故障             ",2,5,0,0,4),
                    new FaultInfo("从控DO/DI检测故障    ",2,6,0,0,4),
                    new FaultInfo("电池极限故障         ",2,7,0,0,4),
                    new FaultInfo("程序和参数不一致故障 ",3,0,0,0,4),
                    new FaultInfo("PCS通讯故障          ",3,1,0,0,4),
                    new FaultInfo("PC强控调试模式       ",3,2,0,0,4),
                    new FaultInfo("CAN霍尔传感器故障    ",3,3,0,0,4),
                    new FaultInfo("CAN霍尔传感器通讯故障",3,4,0,0,4),
                    new FaultInfo("硬件自检异常         ",3,5,0,0,4),
                    new FaultInfo("极柱温度采集故障     ",3,6,0,0,4),
                    new FaultInfo("均衡故障             ",3,7,0,0,4),
                    new FaultInfo("预留                 ",4,0,0,0,4),
                    new FaultInfo("电流差异大告警(一级) ",4,1,0,0,4),
                    new FaultInfo("预留                 ",4,2,0,0,4),
                    new FaultInfo("预充超时             ",4,3,0,0,4),
                    new FaultInfo("脱扣前关闭风扇       ",4,4,0,0,4),
                    new FaultInfo("DBC 使能已开启       ",4,5,0,0,4),
                    new FaultInfo("正常下电失败         ",4,6,0,0,4),
                    new FaultInfo("接收到所有簇故障下电 ",4,7,0,0,4),
        };
